...
LastEditTime: 2023-01-12 17:20:09
'''
import sys
...
class Window_3(Ui_MainWindow, QMainWindow):
    ...
    def show_info(self, w, list):
        ...
        w.item(2).setText("累计接尘量：{} mg/m3·a".format(list[2]))
        w.item(3).setText("预计未来7天接尘量: {} mg/m3·a".format(list[3]))
    ...
    def show_graph(self, w, list):
        ...
        c.addAxis(axis_x, Qt.AlignBottom)
